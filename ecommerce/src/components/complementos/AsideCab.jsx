        ...
        <header className="topAside">
            ...
            <div className="d-inline-flex justify-content-between">
                <div className="d-flex flex-column gap-3">
                    ...
                    <Link className="d-inline-flex align-items-center gap-3" to={"/"}><img src={Home} width={20} className="dark-icons" /><img src={HomeLight} width={20} className="light-icons" /><h5>Inicio</h5></Link>
                </div>
                <ColorMode />
            </div>
